...
PRODUCTS = [
    Product(
        name="Berserk Edicao de Luxo Vol. 40",
        url="https://panini.com.br/berserk-edicao-de-luxo-vol-40-amaxs040r"
    ),
    Product(
        name="Berserk Edicao de Luxo Vol. 39",
        url="https://panini.com.br/berserk-edicao-de-luxo-vol-39-amaxs039r"
    ),
    Product(
        name="Berserk Edicao de Luxo Vol. 37",
        url="https://panini.com.br/berserk-edicao-de-luxo-vol-37-amaxs037r"
    ),
]
...
def send_telegram(title: str, message: str, url: str = None):
    ...
    try:
        ...
        if new_available:
            for prod in new_available:
                ...
                send_notification(
                    title=f"Berserk Disponivel!",
                    message=f"{prod['name']}{price_info} esta disponivel para compra!",
                    url=prod['url']
                )
...
def main():
    ...
    ========================================================
    """.format(service=NOTIFICATION_SERVICE.upper()))
    ...
    send_notification(
        title="Berserk Tracker Iniciado",
        message=f"Monitorando {len(PRODUCTS)} produtos. Intervalo: {CHECK_INTERVAL//60} min"
    )
